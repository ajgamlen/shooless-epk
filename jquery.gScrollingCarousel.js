  ...
  $.fn.extend({
    gScrollingCarousel: function (options) {
      ...
      function updateNavigationVisibility(carousel) {
        ...
        carousel
          .data('rightElem')
          .css('display', left >= maxScrollLeft ? 'none' : 'inline-block')
      }
      ...
      return this.each(function () {
        ...
        if (!supportsTouch || !options.mobileNative) {
          var leftElem = $('<span />')
            .addClass('jc-left')
            .html(
              '<svg focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M10.018 18v-5h10V5h-10V0L0 8.939 10.018 18z"></path></svg>'
            )
          var rightElem = $('<span />')
            .addClass('jc-right')
            .html(
              '<svg focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M10.029 5H0v7.967h10.029V18l9.961-9.048L10.029 0v5z"></path></svg>'
            )
